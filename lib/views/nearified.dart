...
class Nearified extends StatefulWidget {
  final String nearifyId;

  Nearified({this.nearifyId});

  @override
  _NearifiedState createState() => _NearifiedState();
}

class _NearifiedState extends State<Nearified> {
  // @override
